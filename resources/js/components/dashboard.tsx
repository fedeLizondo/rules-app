                    ...
                    <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-3">
                            ...
                            >
                                <CardHeader className="pb-3">
                                    ...
                                    <CardDescription className="max-w-lg text-balance leading-relaxed">
                                        Iniciar busqueda en la red para crear nuevas reglas
                                    </CardDescription>
                                </CardHeader>
                                <CardFooter>
                                    <Button>Buscar Packets</Button>
                                </CardFooter>
                            </Card>
                            <Card x-chunk="dashboard-05-chunk-1">
                                <CardHeader className="pb-2">
                                    <CardDescription>Esta semana</CardDescription>
                                    <CardTitle className="text-4xl">5.157</CardTitle>
                                </CardHeader>
                                <CardContent>
                        ...
                        <Tabs defaultValue="week">
                            <div className="flex items-center">
                                <TabsList>
                                    <TabsTrigger value="week">Request</TabsTrigger>
                                </TabsList>
                                                        ...
                                                        <TableRow key={data.id}>
                                                            <TableCell>
                                                                ...
                                                                <div className="hidden text-sm text-muted-foreground md:inline">
                                                                    {data.url.slice(0, Math.min(data.url.length ?? 0, 40)) + "..."}
                                                                </div>
                                                            </TableCell>
